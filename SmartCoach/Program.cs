...
using SmartCoach.Features.Chat;
using SmartCoach.Features.History;
using SmartCoach.Features.Home;
...
{
    c.SwaggerDoc("v1", new() { Title = "SmartCoach", Version = "1.0" });
